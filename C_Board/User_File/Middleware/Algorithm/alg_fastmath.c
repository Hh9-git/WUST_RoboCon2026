...
float fast_sin(float radians)
{
    ...
    /* input radians is in radians */
    /* Scale input to [0 1] range from [0 2*PI] , divide input by 2*pi */
    in = radians * 0.159154943092f;
...
float fast_cos(float radians)
{
    ...
    in = radians * 0.159154943092f + 0.25f;
...
static const float atan2_coefs[10] =
    {0.0f,
...
static inline float atan_limited(float x)
{
    float res = atan2_coefs[10 - 1];
    int i = 1;
    for (i = 1; i < 10; i++)
    {
        res = x * res + atan2_coefs[10 - 1 - i];
    }
